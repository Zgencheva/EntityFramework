...
namespace ORMFund2.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<MyNewTable> MyNewTables { get; set; } = null!;
        public virtual DbSet<Project> Projects { get; set; } = null!;
        public virtual DbSet<Town> Towns { get; set; } = null!;
        public virtual DbSet<VEmployeeNameJobTitle> VEmployeeNameJobTitles { get; set; } = null!;
        public virtual DbSet<VEmployeesByDepartment> VEmployeesByDepartments { get; set; } = null!;
        public virtual DbSet<VEmployeesHiredAfter2000> VEmployeesHiredAfter2000s { get; set; } = null!;
        public virtual DbSet<VEmployeesSalaries2> VEmployeesSalaries2s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VEmployeesByDepartment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_EmployeesByDepartment");
            ...
            modelBuilder.Entity<VEmployeesSalaries2>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_EmployeesSalaries2");
